...
def funception1(func1, start):
    ...
    >>> def func1(num):
    ...     return num + 1
    >>> func2_1 = funception1(func1, 0)
    >>> func2_1(3)    # func1(0) * func1(1) * func1(2) = 1 * 2 * 3 = 6
    6
    >>> func2_2 = funception1(func1, 1)
    >>> func2_2(4)    # func1(1) * func1(2) * func1(3) = 2 * 3 * 4 = 24
    24
    >>> func2_3 = funception1(func1, 3)
    >>> func2_3(2)    # Returns func1(3) since start >= stop
    4
    >>> func2_4 = funception1(func1, 3)
    >>> func2_4(3)    # Returns func1(3) since start >= stop
    4
    >>> func2_5 = funception1(func1, -2)
    >>> func2_5(-3)    # Returns None since start < 0
    >>> func2_6 = funception1(func1, -1)
    >>> func2_6(4)    # Returns None since start < 0
    """
    def func2(stop):
        nonlocal start
...
def funception2(func1, start):
    ...
    >>> def func1(num):
    ...     return num + 1
    >>> func2_1 = funception2(func1, 0)
    >>> func2_1(3)    # func1(0) * func1(1) * func1(2) = 1 * 2 * 3 = 6
    6
    >>> func2_2 = funception2(func1, 1)
    >>> func2_2(4)    # func1(1) * func1(2) * func1(3) = 2 * 3 * 4 = 24
    24
    >>> func2_3 = funception2(func1, 3)
    >>> func2_3(2)    # Returns func1(3) since start >= stop
    4
    >>> func2_4 = funception2(func1, 3)
    >>> func2_4(3)    # Returns func1(3) since start >= stop
    4
    >>> func2_5 = funception2(func1, -2)
    >>> func2_5(-3)    # Returns None since start < 0
    >>> func2_6 = funception2(func1, -1)
    >>> func2_6(4)    # Returns None since start < 0
    """
    def func2(stop):
        i = start
